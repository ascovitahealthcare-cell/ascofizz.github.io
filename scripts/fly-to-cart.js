/* ═══════════════════════════════════════════════════════════════════
   ...
   Adapted to the Ascofizz design language:
     ...
     • Ascofizz moss accents (--indigo #2F5545, --indigo-hi #55836C)
...
.fly-ghost {
  ...
  border: 2px solid var(--indigo-hi, #55836C);
...
.ofc-fab .ofc-count {
  ...
  border-radius: 999px;
  background: #fff; color: var(--indigo, #2F5545);
  ...
  function hookBundleBuilder() {
    ...
    window.__ofcAddBundleToCart = function () {
      ...
      if (imgs.length) {
        ...
        badge.style.cssText = 'position:absolute;top:-8px;right:-8px;background:var(--indigo,#2F5545);color:#fff;font-size:.68rem;font-weight:900;min-width:20px;height:20px;border-radius:999px;display:flex;align-items:center;justify-content:center;padding:0 5px;box-shadow:0 2px 8px rgba(0,0,0,.25)';
